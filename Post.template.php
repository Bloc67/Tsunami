...
function template_main()
{
	...
	echo '
			<div id="preview_section" class="post"', isset($context['preview_message']) ? '' : ' style="display: none;"', '>
				<h3 class="header_name">
					<span id="preview_subject">', empty($context['preview_subject']) ? '' : $context['preview_subject'], '</span>
				</h3>
				<div class="inner" id="preview_body">
	...
	echo '
			<h3 class="header_name">', $context['page_title'], '</h3>
			', isset($context['current_topic']) ? '<input type="hidden" name="topic" value="' . $context['current_topic'] . '" />' : '';

	// If an error occurred, explain what happened.
	echo '
			<div class="information red"', empty($context['post_error']['messages']) ? ' style="display: none"' : '', ' id="errors">
				<h4 class="header_name" style="', empty($context['error_type']) || $context['error_type'] != 'serious' ? 'display: none;' : '', '" id="error_serious">', $txt['error_while_submitting'], '</h4>
				<span class="error" id="error_list">
	...
	{
		echo '
					<h4 class="header_name">	', $txt['attached'], ':</h4>
					<ul class="post_options single" id="postAttachment">
						<li>
							<input type="hidden" name="attach_del[]" value="0" />
							<small>', $txt['uncheck_unwatchd_attach'], ':</small>
						</li>';
	...
	{
		echo '
					<h4 class="header_name">', $txt['attach'], ':</h4>
					<ul id="postAttachment2" class="post_options single">
						<li class="smalltext">
			...
			echo '
							<script type="text/javascript"><!-- // --><![CDATA[
								...
								function addAttachment()
								{
									...
									setOuterHTML(document.getElementById("moreAttachments"), \'<li class="smalltext"><input type="file" size="60" name="attachment[]" id="attachment\' + current_attachment + \'" class="input_file" /> (<a href="javascript:void(0);" onclick="cleanFileInput(\\\'attachment\' + current_attachment + \'\\\');">', $txt['clean_attach'], '</a>)\' + \'</dd><dd class="smalltext" id="moreAttachments"><a href="#" onclick="addAttachment(); return false;">(', $txt['more_attachments'], ')<\' + \'/a><\' + \'/li>\');

									return true;
								}
							// ]]></script>
						</li>
						<li class="smalltext" id="moreAttachments"><a href="#" onclick="addAttachment(); return false;">(', $txt['more_attachments'], ')</a></li>';
	...
	echo '
			...
			function onDocSent(XMLDoc)
			{
				...
				document.getElementById(\'preview_body\').className = \'inner\';
