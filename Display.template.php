...
<div id="a_maside">
	...
	<div id="poll">
		...
		$poll_buttons = array(
			...
			'results' => array('active' => 1,'icon' => 'icon-doc-text', 'test' => 'show_view_results_button', 'text' => 'poll_results', 'image' => 'poll_results.gif', 'lang' => true, 'url' => $scripturl . '?topic=' . $context['current_topic'] . '.' . $context['start'] . ';viewresults'),
