...
<div id="a_maside">
	...
	<div id="poll">
		...
		$poll_buttons = array(
			'vote' => array('active' => true, 'icon' => 'icon-flag', 'test' => 'allow_return_vote', 'text' => 'poll_return_vote', 'image' => 'poll_options.gif', 'lang' => true, 'url' => $scripturl . '?topic=' . $context['current_topic'] . '.' . $context['start']),
