			...
			<div>
				<div class="roundframe">
					...
					<fieldset id="poll_main">
						...
						<input type="text" name="question" value="', $context['poll']['question'], '" class="input_text" />
						<ul class="poll_main optionsettings reset">';

	foreach ($context['choices'] as $choice)
	{
		echo '
							<li>
								<label for="options-', $choice['id'], '" ', (isset($context['poll_error']['poll_few']) ? ' class="error"' : ''), '>', $txt['option'], ' ', $choice['number'];
		...
		echo '
								...
								<input type="text" name="options[', $choice['id'], ']" id="options-', $choice['id'], '" value="', $choice['label'], '" class="input_text" maxlength="255" />
							</li>';
	}
